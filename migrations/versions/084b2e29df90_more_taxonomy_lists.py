...
def upgrade():
    ...
    op.create_table(
        "satzart_allgemein_to_satz",
        sa.Column("satz_id", sa.Integer(), nullable=False),
        sa.Column("satzart_allgemein_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["satz_id"],
            ["satz.id"],
            name=op.f("fk_satzart_allgemein_to_satz_satz_id_satz"),
        ),
        sa.ForeignKeyConstraint(
            ["satzart_allgemein_id"],
            ["satzart_allgemein.id"],
            name=op.f(
                "fk_satzart_allgemein_to_satz_satzart_allgemein_id_satzart_allgemein"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "satz_id", "satzart_allgemein_id", name=op.f("pk_satzart_allgemein_to_satz")
        ),
    )
    op.create_table(
        "satzart_speziell_to_satz",
        sa.Column("satz_id", sa.Integer(), nullable=False),
        sa.Column("satzart_speziell_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["satz_id"],
            ["satz.id"],
            name=op.f("fk_satzart_speziell_to_satz_satz_id_satz"),
        ),
        sa.ForeignKeyConstraint(
            ["satzart_speziell_id"],
            ["satzart_speziell.id"],
            name=op.f("fk_satzart_speziell_to_satz_satzart_speziell_id_satzart_speziell"),
        ),
        sa.PrimaryKeyConstraint(
            "satz_id", "satzart_speziell_id", name=op.f("pk_satzart_speziell_to_satz")
        ),
    )
    op.create_table(
        "harmonische_funktion_to_harmonics",
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f(
                "fk_harmonische_funktion_to_harmonics_harmonic_function_modulation_id_harmonische_funktion_verwandschaft"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["harmonics_id"],
            ["harmonics.id"],
            name=op.f("fk_harmonische_funktion_to_harmonics_harmonics_id_harmonics"),
        ),
        sa.PrimaryKeyConstraint(
            "harmonics_id",
            "harmonic_function_modulation_id",
            name=op.f("pk_harmonische_funktion_to_harmonics"),
        ),
    )
    op.create_table(
        "auftreten_satz_to_part",
        sa.Column("part_id", sa.Integer(), nullable=False),
        sa.Column("auftreten_satz_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["auftreten_satz_id"],
            ["auftreten_satz.id"],
            name="fk_auftreten_satz_to_part_auftreten_satz_id",
        ),
        sa.ForeignKeyConstraint(
            ["part_id"], ["part.id"], name=op.f("fk_auftreten_satz_to_part_part_id_part")
        ),
        sa.PrimaryKeyConstraint(
            "part_id", "auftreten_satz_id", name=op.f("pk_auftreten_satz_to_part")
        ),
    )
    op.create_table(
        "intervallik_to_voice",
        sa.Column("voice_id", sa.Integer(), nullable=False),
        sa.Column("intervallik_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["intervallik_id"],
            ["intervallik.id"],
            name=op.f("fk_intervallik_to_voice_intervallik_id_intervallik"),
        ),
        sa.ForeignKeyConstraint(
            ["voice_id"],
            ["voice.id"],
            name=op.f("fk_intervallik_to_voice_voice_id_voice"),
        ),
        sa.PrimaryKeyConstraint(
            "voice_id", "intervallik_id", name=op.f("pk_intervallik_to_voice")
        ),
    )
    ...
    with op.batch_alter_table("sub_part", schema=None) as batch_op:
        batch_op.drop_constraint(
            "fk_sub_part_ambitus_id_ambitus_group", type_="foreignkey"
        )
    ...
    with op.batch_alter_table("voice", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_measure_start_id_measure"),
            "measure",
            ["measure_start_id"],
            ["id"],
        )
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_ambitus_id_ambitus_group"),
            "ambitus_group",
            ["ambitus_id"],
            ["id"],
        )
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_measure_end_id_measure"),
            "measure",
            ["measure_end_id"],
            ["id"],
        )
...
def downgrade():
    ...
    with op.batch_alter_table("voice", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("fk_voice_measure_end_id_measure"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_voice_ambitus_id_ambitus_group"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_voice_measure_start_id_measure"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "voice_ibfk_4", "intervallik", ["intervallik_id"], ["id"]
        )
        batch_op.drop_column("ambitus_id")
    ...
    with op.batch_alter_table("sub_part", schema=None) as batch_op:
        batch_op.add_column(sa.Column("ambitus_id", sa.INTEGER(), nullable=True))
        batch_op.create_foreign_key(
            "fk_sub_part_ambitus_id_ambitus_group",
            "ambitus_group",
            ["ambitus_id"],
            ["id"],
        )
    ...
    with op.batch_alter_table("satz", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "satz_ibfk_1", "satzart_allgemein", ["satzart_allgemein_id"], ["id"]
        )
        batch_op.create_foreign_key(
            "satz_ibfk_2", "satzart_speziell", ["satzart_speziell_id"], ["id"]
        )
    ...
    with op.batch_alter_table("part", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "part_ibfk_7", "auftreten_satz", ["occurence_in_movement_id"], ["id"]
        )
