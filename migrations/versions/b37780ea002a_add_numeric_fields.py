...
def upgrade():
    ...
    with op.batch_alter_table("harmonics", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("numeric_degree_of_dissonance", sa.Float(), nullable=True)
        )
        batch_op.add_column(
            sa.Column("numeric_harmonic_density", sa.Float(), nullable=True)
        )
        batch_op.add_column(
            sa.Column("numeric_harmonic_complexity", sa.Float(), nullable=True)
        )
