...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["highest_octave_id"],
            ["oktave.id"],
            name=op.f("fk_ambitus_group_highest_octave_id_oktave"),
        ),
        sa.ForeignKeyConstraint(
            ["highest_pitch_id"],
            ["grundton.id"],
            name=op.f("fk_ambitus_group_highest_pitch_id_grundton"),
        ),
        sa.ForeignKeyConstraint(
            ["lowest_octave_id"],
            ["oktave.id"],
            name=op.f("fk_ambitus_group_lowest_octave_id_oktave"),
        ),
        sa.ForeignKeyConstraint(
            ["lowest_pitch_id"],
            ["grundton.id"],
            name=op.f("fk_ambitus_group_lowest_pitch_id_grundton"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_ambitus_group")),
    )
    op.create_table(
        "formale_funktion_to_part",
        sa.Column("part_id", sa.Integer(), nullable=False),
        sa.Column("formale_funktion_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["formale_funktion_id"],
            ["formale_funktion.id"],
            name=op.f("fk_formale_funktion_to_part_formale_funktion_id"),
        ),
        sa.ForeignKeyConstraint(
            ["part_id"],
            ["part.id"],
            name=op.f("fk_formale_funktion_to_part_part_id_part"),
        ),
        sa.PrimaryKeyConstraint(
            "part_id", "formale_funktion_id", name=op.f("pk_formale_funktion_to_part")
        ),
    )
    op.create_table(
        "musikalische_wendung_to_voice",
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_musikalische_wendung_to_voice_musikalische_wendung_id"),
        ),
        sa.ForeignKeyConstraint(
            ["voice_id"],
            ["voice.id"],
            name=op.f("fk_musikalische_wendung_to_voice_voice_id_voice"),
        ),
        sa.PrimaryKeyConstraint(
            "voice_id",
            "musikalische_wendung_id",
            name=op.f("pk_musikalische_wendung_to_voice"),
        ),
    )
    ...
    with op.batch_alter_table("sub_part", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("fk_sub_part_ambitus_id_ambitus_group"),
            "ambitus_group",
            ["ambitus_id"],
            ["id"],
        )
    ...
    with op.batch_alter_table("voice", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_composition_id_composition"),
            "composition",
            ["composition_id"],
            ["id"],
        )
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_rhythm_id_rhythm"), "rhythm", ["rhythm_id"], ["id"]
        )
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_rendition_id_rendition"),
            "rendition",
            ["rendition_id"],
            ["id"],
        )
        batch_op.create_foreign_key(
            batch_op.f("fk_voice_citations_id_citations"),
            "citations",
            ["citations_id"],
            ["id"],
        )
...
def downgrade():
    ...
    with op.batch_alter_table("voice", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("fk_voice_citations_id_citations"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_voice_rendition_id_rendition"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_voice_rhythm_id_rhythm"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_voice_composition_id_composition"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "voice_ibfk_1", "oktave", ["highest_octave_id"], ["id"]
        )
        batch_op.create_foreign_key(
            "voice_ibfk_6", "grundton", ["lowest_pitch_id"], ["id"]
        )
        batch_op.create_foreign_key(
            "voice_ibfk_5", "oktave", ["lowest_octave_id"], ["id"]
        )
        batch_op.create_foreign_key(
            "voice_ibfk_2", "grundton", ["highest_pitch_id"], ["id"]
        )
        batch_op.drop_column("rhythm_id")
        batch_op.drop_column("rendition_id")
        batch_op.drop_column("composition_id")
    ...
    with op.batch_alter_table("sub_part", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("rhythm_id", sa.INTEGER(), nullable=True))
        batch_op.drop_constraint(
            batch_op.f("fk_sub_part_ambitus_id_ambitus_group"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "sub_part_ibfk_1", "citations", ["citations_id"], ["id"]
        )
        ...
        batch_op.create_foreign_key(
            "sub_part_ibfk_9", "rendition", ["rendition_id"], ["id"]
        )
        batch_op.create_foreign_key(
            "sub_part_ibfk_2", "composition", ["composition_id"], ["id"]
        )
    ...
    with op.batch_alter_table("person", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("canonical_name", sa.VARCHAR(length=191), nullable=True)
        )
        batch_op.create_index(
            "ix_person_canonical_name", ["canonical_name"], unique=False
        )
        batch_op.alter_column(
            "nationality",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "sub_part_id",
            "musikalische_wendung_id",
            name="pk_musikalische_wendung_to_sub_part",
        ),
    )
    op.create_table(
        "formale_funktion_to_form",
        sa.Column("form_id", sa.INTEGER(), nullable=False),
        sa.Column("formale_funktion_id", sa.INTEGER(), nullable=False),
        sa.ForeignKeyConstraint(
            ["form_id"], ["form.id"], name="fk_formale_funktion_to_form_form_id_form"
        ),
        sa.ForeignKeyConstraint(
            ["formale_funktion_id"],
            ["formale_funktion.id"],
            name="fk_formale_funktion_to_form_formale_funktion_id_formale_funktion",
        ),
        sa.PrimaryKeyConstraint(
            "form_id", "formale_funktion_id", name="pk_formale_funktion_to_form"
        ),
    )
    op.create_table(
        "form",
        ...
        sa.ForeignKeyConstraint(
            ["form_schema_id"], ["formschema.id"], name="form_ibfk_1"
        ),
