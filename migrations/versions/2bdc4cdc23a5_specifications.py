...
def upgrade():
    ...
    spezifikation_anteil = op.create_table(
    ...
    spezifikation_auftreten = op.create_table(
    ...
    spezifikation_instrument = op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["spezifikation_instrument.id"],
            name=op.f("fk_spezifikation_instrument_parent_id_spezifikation_instrument"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["occurence_id"],
            ["spezifikation_auftreten.id"],
            name=op.f("fk_part_specification_occurence_id_spezifikation_auftreten"),
        ),
        sa.ForeignKeyConstraint(
            ["parent_id"], ["part.id"], name=op.f("fk_part_specification_parent_id_part")
        ),
        sa.ForeignKeyConstraint(
            ["share_id"],
            ["spezifikation_anteil.id"],
            name=op.f("fk_part_specification_share_id_spezifikation_anteil"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_part_specification")),
    )
    op.create_table(
        "part_spec_instrument_to_specification",
        sa.Column("specifications_id", sa.Integer(), nullable=False),
        sa.Column("spezifikation_instrument_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["specifications_id"],
            ["part_specification.id"],
            name=op.f(
                "fk_part_spec_instrument_to_specification_specifications_id_part_specification"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["spezifikation_instrument_id"],
            ["spezifikation_instrument.id"],
            name=op.f(
                "fk_part_spec_instrument_to_specification_spezifikation_instrument_id_spezifikation_instrument"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "specifications_id",
            "spezifikation_instrument_id",
            name=op.f("pk_part_spec_instrument_to_specification"),
        ),
    )
    op.create_table(
        "sub_part_specification",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("path", sa.Text(), nullable=True),
        sa.Column("parent_id", sa.Integer(), nullable=True),
        sa.Column("share_id", sa.Integer(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["occurence_id"],
            ["spezifikation_auftreten.id"],
            name=op.f("fk_sub_part_specification_occurence_id_spezifikation_auftreten"),
        ),
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["sub_part.id"],
            name=op.f("fk_sub_part_specification_parent_id_sub_part"),
        ),
        sa.ForeignKeyConstraint(
            ["share_id"],
            ["spezifikation_anteil.id"],
            name=op.f("fk_sub_part_specification_share_id_spezifikation_anteil"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_sub_part_specification")),
    )
    op.create_table(
        "sub_part_spec_instrument_to_specification",
        sa.Column("specifications_id", sa.Integer(), nullable=False),
        sa.Column("spezifikation_instrument_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["specifications_id"],
            ["sub_part_specification.id"],
            name=op.f(
                "fk_sub_part_spec_instrument_to_specification_specifications_id_sub_part_specification"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["spezifikation_instrument_id"],
            ["spezifikation_instrument.id"],
            name=op.f(
                "fk_sub_part_spec_instrument_to_specification_spezifikation_instrument_id_spezifikation_instrument"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "specifications_id",
            "spezifikation_instrument_id",
            name=op.f("pk_sub_part_spec_instrument_to_specification"),
        ),
    )
    op.create_table(
        "voice_specification",
        ...
        sa.ForeignKeyConstraint(
            ["occurence_id"],
            ["spezifikation_auftreten.id"],
            name=op.f("fk_voice_specification_occurence_id_spezifikation_auftreten"),
        ),
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["voice.id"],
            name=op.f("fk_voice_specification_parent_id_voice"),
        ),
        sa.ForeignKeyConstraint(
            ["share_id"],
            ["spezifikation_anteil.id"],
            name=op.f("fk_voice_specification_share_id_spezifikation_anteil"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_voice_specification")),
    )
    op.create_table(
        "voice_spec_instrument_to_specification",
        sa.Column("specifications_id", sa.Integer(), nullable=False),
        sa.Column("spezifikation_instrument_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["specifications_id"],
            ["voice_specification.id"],
            name=op.f(
                "fk_voice_spec_instrument_to_specification_specifications_id_voice_specification"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["spezifikation_instrument_id"],
            ["spezifikation_instrument.id"],
            name=op.f(
                "fk_voice_spec_instrument_to_specification_spezifikation_instrument_id_spezifikation_instrument"
            ),
        ),
        sa.PrimaryKeyConstraint(
            "specifications_id",
            "spezifikation_instrument_id",
            name=op.f("pk_voice_spec_instrument_to_specification"),
        ),
    )
    ...
    count = connection.execute(
        sa.select(sa.func.count(instrument.c.id))
    ).scalar_one_or_none()
    if count == 0:
        ...
        extra_instruments.append(
            {
                ...
                "parent_id": (
                    instruments_id_map[parent_id] if parent_id is not None else None
                ),
                "name": name,
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"id": 3, "parent_id": 1, "name": "tutti", "description": ""},
            {
                "id": 4,
                "parent_id": 1,
                "name": "alle Instrumente die am Werkausschnitt beteiligt sind",
                "description": "",
            },
            {
                "id": 5,
                "parent_id": 1,
                "name": "nur folgendes besetzte Instrumente/Instrumentengruppen",
                "description": "",
            },
            *extra_instruments,
        ],
