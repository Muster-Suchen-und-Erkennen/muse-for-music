...
harmonics_put = api.model('HarmonicsPUT', OrderedDict([
    ...
    ('numeric_degree_of_dissonance', fields.Float(min=-1, minimum=0, max=100, default=-1, title='Dissonanzgrad (numerisch)')),
    ...
    ('numeric_harmonic_complexity', fields.Float(min=-1, minimum=0, max=100, default=-1, title='Harmonische Komplexität (numerisch)')),
    ('harmonic_density', fields.Nested(taxonomy_item_ref, taxonomy='HarmonischeDichte', title='Harmonische Dichte')),
    ('numeric_harmonic_density', fields.Float(min=-1, minimum=0, max=100, default=-1, title='Harmonische Dichte (numerisch)')),
...
harmonics_get = api.model('HarmonicsGET', OrderedDict([
    ...
    ('numeric_degree_of_dissonance', fields.Float(min=-1, max=100, default=-1, title='Dissonanzgrad (numerisch)')),
    ...
    ('numeric_harmonic_complexity', fields.Float(min=-1, max=100, default=-1, title='Harmonische Komplexität (numerisch)')),
    ('harmonic_density', fields.Nested(taxonomy_item_get, taxonomy='HarmonischeDichte', title='Harmonische Dichte')),
    ('numeric_harmonic_density', fields.Float(min=-1, max=100, default=-1, title='Harmonische Dichte (numerisch)')),
