...
harmonics_put = api.model('HarmonicsPUT', {
    ...
    'melody_tones_in_melody_one': fields.Nested(taxonomy_item_put, allow_null=True, description='AnzahlMelodietoene'),
    'melody_tones_in_melody_two': fields.Nested(taxonomy_item_put, allow_null=True, description='AnzahlMelodietoene'),
...
harmonics_get = api.model('HarmonicsGET', {
    ...
    'nr_of_melody_tones_per_harmony': fields.Float(),
    'melody_tones_in_melody_one': fields.Nested(taxonomy_item_get, allow_null=True, description='AnzahlMelodietoene'),
    'melody_tones_in_melody_two': fields.Nested(taxonomy_item_get, allow_null=True, description='AnzahlMelodietoene'),
